...
public class AppTest 
{
    ...
    @BeforeTest
    public void setup(){
        ExtentSparkReporter ereport=new ExtentSparkReporter("F:\\reports\\report.html");
        reports=new ExtentReports();
        reports.attachReporter(ereport);
        PropertyConfigurator.configure("F:\\reports\\log4j.properties");
    }
    @BeforeMethod
    ...
    public void Test1() throws Exception
    {
        ...
        FileInputStream fs = new FileInputStream("C:\\Users\\SARVESHWARAN\\OneDrive\\Desktop\\Book1.xlsx");
